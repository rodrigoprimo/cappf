...
<table border="0" cellpadding="0" cellspacing="0"><tbody>
	<tr valign="bottom">
		<td align="right"><img src="styles/cappf/tl.png"></td>
		<td ><img src="styles/cappf/t.png" height="12" width="{$item.size_x}"></td>
		<td align="left"><img src="styles/cappf/tr.png"></td></tr>
	<tr>
		<td ><img src="styles/cappf/l.png" width="4" height="{$item.size_y}"></td>
		<td align="center">

       <a href="tiki-browse_gallery.php?galleryId={$item.galleryId}"><img alt="{tr}subgallery{/tr} {$item.name}" class="athumb" src="show_image.php?id={$item.imageId}&amp;thumb=1" border="0" /></a>

		</td>
		<td ><img src="styles/cappf/r.png" width="14" height="{$item.size_y}"></td></tr>
	<tr>
		<td align="right"><img src="styles/cappf/bl.png"></td>
		<td><img src="styles/cappf/b.png" height="10" width="{$item.size_x}"></td>
		<td align="left"><img src="styles/cappf/br.png"></td></tr>
</tbody></table>
...
<table border="0" cellpadding="0" cellspacing="0"><tbody>
	<tr valign="bottom">
		<td align="right"><img src="styles/cappf/tl_foto.png"></td>
		<td style="background-image: url('styles/cappf/t_foto.png'); background-repeat: repeat-x;" height="12"></td>
		<td align="left"><img src="styles/cappf/tr_foto.png"></td></tr>
	<tr>
		<td style="background-image: url('styles/cappf/l_foto.png'); background-repeat: repeat-y" width="4"></td>
		<td align="center">
	...
	<tr>
		...
		{if $showhits=='y'}[{$item.hits} {if $item.hits == 1}{tr}hit{/tr}{else}{tr}hits{/tr}{/if}]{/if}
          <br />
<table border="0" cellpadding="0" cellspacing="0"><tbody><tr><td valign="middle">
          {if $tiki_p_admin_galleries eq 'y' or ($user and $user eq $owner)}
	    		{if $nextx!=0}
            		<a class="gallink" href="tiki-browse_image.php?galleryId={$galleryId}&amp;sort_mode={$sort_mode}&amp;imageId={$item.imageId}&amp;scalesize=0" title="{tr}original size{/tr}"><img src='img/icons2/nav_dot.gif' border='0' width='8' height='11' alt='{tr}original size{/tr}' title='{tr}original size{/tr}' /></a>&nbsp;&nbsp;</td><td valign="middle">
	    		{/if}
            	{if $imagerotate}
            		<a class="gallink" href="tiki-browse_gallery.php?galleryId={$galleryId}&amp;rotateright={$item.imageId}" title="{tr}rotate right{/tr}"><img src='img/icons2/admin_rotate.gif' border='0' width='11' height='11 alt='{tr}rotate{/tr}' title='{tr}rotate{/tr}' /></a>&nbsp;&nbsp;</td><td valign="middle">
            	{/if}
            	<a class="gallink" href="tiki-browse_gallery.php?galleryId={$galleryId}&amp;remove={$item.imageId}" title="{tr}delete{/tr}"><img src='img/icones/x.png' border='0' alt='{tr}delete{/tr}' title='{tr}delete{/tr}' /></a>&nbsp;&nbsp;</td><td valign="middle">
            	<a class="gallink" href="tiki-edit_image.php?galleryId={$galleryId}&amp;edit={$item.imageId}" title="{tr}edit{/tr}"><img src='img/icones/photos.png' border='0' alt='{tr}edit{/tr}' title='{tr}edit{/tr}' /></a>&nbsp;&nbsp;</td><td valign="middle">
          {/if}
...
<img src='img/icones/search.png' border='0' alt='{tr}popup{/tr}' title='{tr}popup{/tr}' /></a>
</td></tr></tbody></table>
          <br />
	</small>
         </td>
