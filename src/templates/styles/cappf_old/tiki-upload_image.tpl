{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-upload_image.tpl,v 1.22.2.23 2006/05/21 18:55:40 marclaporte Exp $ *}
...
{if count($galleries) > 0}
  ...
  <tr><td class="formcolor">{tr}Latitude (WGS84/decimal degrees){/tr}:</td><td class="formcolor"><input type="text" name="lat" value="{$prefs.lat|escape}" /></td></tr>
  <tr><td class="formcolor">{tr}Longitude (WGS84/decimal degrees){/tr}:</td><td class="formcolor"><input type="text" name="lon" value="{$prefs.lon|escape}" /></td></tr>
  {/if}
